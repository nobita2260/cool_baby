...
## logo 
logo="""ooo____oo____oooo____ooooooo__oooo_oooooooo____ooo_______
\033[1;92moooo___oo__oo____oo__oo____oo__oo_____oo_____oo___oo_____
\033[1;93moo_oo__oo_oo______oo_oooooooo__oo_____oo____oo_____oo____
\033[1;94moo__oo_oo_oo______oo_oo____oo__oo_____oo____ooooooooo____         
\033[1;95moo___oooo__oo____oo__oo____oo__oo_____oo____oo_____oo____
\033[1;96moo____ooo____oooo____ooooooo__oooo____oo____oo_____oo____ 
\033[1;98m-----------------------------------------------
\033[1;99m  Author : ℕ𝕆𝔹𝕀𝕋𝔸𝟚𝟚𝟞𝟘
\033[1;97m-------------------ℕ𝕆𝔹𝕀𝕋𝔸----------------"""
wwn = pilih([U, C, B, Q])

loag="""ooo____oo____oooo____ooooooo__oooo_oooooooo____ooo_______
\033[1;92moooo___oo__oo____oo__oo____oo__oo_____oo_____oo___oo_____
\033[1;93moo_oo__oo_oo______oo_oooooooo__oo_____oo____oo_____oo____
\033[1;94moo__oo_oo_oo______oo_oo____oo__oo_____oo____ooooooooo____    
\033[1;95moo___oooo__oo____oo__oo____oo__oo_____oo____oo_____oo____
...
class menu:
	def __init__(self):
		...
		print ("")
		print ("")
		print(I+"\x1b[1;97m[01] 𝐃𝐔𝐌𝐏 𝐎𝐍𝐋𝐘 𝟏 𝐋𝐈𝐍𝐊 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐅𝐈𝐋𝐄 𝐌𝐀𝐊𝐄𝐑  ")
		print(I+"\x1b[1;97m[02] 𝐒𝐋𝐈𝐂𝐄 𝐀𝐍𝐃 𝐒𝐎𝐑𝐓 𝐅𝐈𝐋𝐄  (\x1b[1;92mAuto\x1b[1;97m)")
		print(I+"\x1b[1;97m[03] 𝐒𝐋𝐈𝐂𝐄 𝐀𝐍𝐃 𝐒𝐎𝐑𝐓 𝐅𝐈𝐋𝐄  (\x1b[1;92mChoice\x1b[1;97m)")
		print(I+"\x1b[1;97m[04] 𝐑𝐄𝐌𝐎𝐕𝐄 𝐃𝐎𝐔𝐁𝐋𝐄 𝐋𝐈𝐍𝐊𝐒 (\x1b[1;92mAuto\x1b[1;97m)")
		print(C+"\x1b[1;97m[00] 𝐑𝐄𝐌𝐎𝐕𝐄 𝐓𝐎𝐊𝐄𝐍  (\x1b[1;91mToken & Cookies\x1b[1;97m)")
		ba=input("\n\x1b[1;97m[*] 𝐂𝐡𝐨𝐨𝐬𝐞 𝐨𝐩𝐭𝐢𝐨𝐧 : ")
		if ba in [""," "]: 
			print(war+"𝐃𝐨𝐧'𝐭 𝐄𝐦𝐩𝐭𝐲 𝐏𝐥𝐞𝐚𝐬𝐞 𝐒𝐞𝐥𝐞𝐜𝐭 𝐨𝐧𝐞 ")
			time.sleep(2)
			menu()
		elif ba in ["1","01"]:
			dump_ulti()
...
class login:
	def __init__(self):
		...
		jalan("  ( 𝐒𝐞𝐥𝐞𝐜𝐭 𝐋𝐨𝐠𝐢𝐧 𝐌𝐞𝐭𝐡𝐨𝐝 )\n")
		
		print ("[1] 𝐋𝐨𝐠𝐢𝐧 𝐖𝐢𝐭𝐡 𝐓𝐨𝐤𝐞𝐧")
		print ("[2] 𝐋𝐨𝐠𝐢𝐧 𝐖𝐢𝐭𝐡 𝐂𝐨𝐨𝐤𝐢𝐞𝐬")
		...
		if h_ in ["1", "01", "𝕥𝕠𝕜𝕖𝕟"]:
			token()
		elif h_ in ["2", "02", "𝕔𝕠𝕜𝕚𝕖𝕤"]:
			coke()
		else:jalan(war+"𝐅𝐢𝐥𝐥 𝐈𝐧 𝐂𝐨𝐫𝐫𝐞𝐜𝐭𝐥𝐲");time.sleep(1);login()
class msort:
	def __init__(self):
		print(47*'-')
	...
	def __init__(self):
		...
		for naa in token_free:
			...
			if len(naa)>=37:
				...
				cek_token(naa)
		exit(war+"𝐓𝐨𝐤𝐞𝐧 𝐍𝐨𝐭 𝐅𝐨𝐮𝐧𝐝")
class token:
	def __init__(self):
		toket = input("\n\033[1;97m[+] 𝐄𝐧𝐭𝐞𝐫 𝐓𝐨𝐤𝐞𝐧 : ")
